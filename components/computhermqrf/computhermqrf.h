...
namespace esphome
{
    namespace computhermqrf
    {
        ...
        public:
            ...
            void set_receiver_pin(InternalGPIOPin *pin)
            {
                this->receiver_pin_ = pin;
            }
            ...
            void set_last_unregistered_address_text_sensor(text_sensor::TextSensor *sensor)
            {
                this->last_unregistered_address_text_sensor_ = sensor;
            }
#endif
        ...
        public:
            ...
            {
                parent->add_on_code_received_callback([&](ComputhermQRFData &data)
                                                      { this->trigger(data); });
            }
        };
